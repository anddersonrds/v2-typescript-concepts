...
Deve criar uma aplicação com Node.js junto ao TypeScript, utilizando o conceito de models, repositories e services!
...
Ao fazer o gitclone execute o seguintes comandos dentro da pasta do projeto:

```yarn``` para baixar todas as dependências ultilzadas.

```yarn dev:server``` para rodar a aplicação.

``yarn test`` para rodar os testes.

Na raiz do projeto está o arquivo **insomnia.json** para importar no Insomnia para utilizar a rotas já configuradas.
...
Feito com 💜 by Anderson Rodrigues
